...
start "Celery Worker" cmd /k "cd /d C:\Users\Administrator\Documents\WebApplication && .venv\Scripts\activate && python -m celery -A source.celery worker --loglevel=info -P threads"
